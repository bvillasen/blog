...
Changed to different animation vcodec: yuv420p second try
<div style="text-align: center">
<video src="{{ site.url }}assets/videos/phase_diagram_nyx_cholla_yuv_new.mp4" width="100%"  height="auto" controls preload> </video>
</div>
