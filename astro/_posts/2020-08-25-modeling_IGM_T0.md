...
Rescaling the HeII photoionization and photoheating rates by HeII_factor results in different trajectories for HeII reionization but they all converge to the same evolution after $$z \lesssim 3$$ as shown if the figure below
